    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscribe', models.BooleanField(verbose_name='subscribe')),
                ('email_transaction', models.BooleanField(verbose_name='email transaction')),
                ('email_trip_info', models.BooleanField(verbose_name='email trip info')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
