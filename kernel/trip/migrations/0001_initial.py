# Generated by Django 2.1.7 on 2019-03-25 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='region', to='trip.City')),
            ],
            options={
                'verbose_name': 'Region',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.PositiveSmallIntegerField(choices=[(1, 'front seat'), (2, 'left seat'), (3, 'middle seat'), (4, 'right seat')], verbose_name='position')),
                ('state', models.PositiveSmallIntegerField(choices=[(1, 'singular'), (2, 'plural')], verbose_name='state')),
                ('init_price', models.PositiveIntegerField(verbose_name='price')),
                ('paid_price', models.PositiveIntegerField(null=True, verbose_name='paid_price')),
                ('type_price', models.SmallIntegerField(choices=[(1, 'cash'), (2, 'online')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destiantion_region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_reg_dest', to='trip.Region', verbose_name='destination region')),
        ...
        migrations.AddField(
            model_name='seat',
            name='trip',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seat', to='trip.Trip', verbose_name='trip'),
        ),
        migrations.AddField(
            model_name='seat',
            name='user',
